...
function withDimensions(WrappedComponent) {
  class EnhancedComponent extends React.Component {
    constructor(props) {
      ...
      _defineProperty(this, "onDimensionChangedEventSubscriber", null);
    ...
    componentDidMount() {
      this.onDimensionChangedEventSubscriber = _reactNative.Dimensions.addEventListener('change', this.handleOrientationChange);
    }

    componentWillUnmount() {
      var _this$onDimensionChan;

      (_this$onDimensionChan = this.onDimensionChangedEventSubscriber) === null || _this$onDimensionChan === void 0 ? void 0 : _this$onDimensionChan.remove();
    }
